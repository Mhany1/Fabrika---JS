...
// http://localhost:1337/api/cars?populate=*?filter=[size][==]="SEDAN"npt
...
function ShowFilter() {
  //Animate the arrow when clicked
  let btn = document.getElementById("btn_show_filter");

  document.getElementsByClassName("fa-angle-right")[0].style.transform =
